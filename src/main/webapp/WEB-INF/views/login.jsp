...
<div class="row w-100" style="padding-top: 175px;">
  ...
  <div class="col-lg-5 d-flex">
    <div class="form-wrapper is-active">
      ...
      <form method="POST" action="${pageContext.request.contextPath}/process_login" class="form form-login">
        <c:if test="${param.error != null}">
      		<p class="form-error">Sorry! incorrect username or password</p>
      	</c:if>
      	
      	<c:if test="${param.logout != null}">
      		<p class="form-success">You have been logged out</p>
      	</c:if>
    ...
    <div class="form-wrapper">
      <button type="button" class="switcher switcher-signup">
        ...
        <form:form method="POST" action="${pageContext.request.contextPath}/login" class="form form-signup" modelAttribute="user">
        <fieldset>
